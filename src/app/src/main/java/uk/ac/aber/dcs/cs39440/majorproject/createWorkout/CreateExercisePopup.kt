...
@Composable
fun CreateExercisePopup(
    exerciseList: MutableList<Exercise>,
    visible: MutableState<Boolean>
) {
    val exerciseName = remember { mutableStateOf("") }
    val exerciseType = remember { mutableStateOf(ExerciseType.None) }
    val exerciseDurationS = remember { mutableStateOf("0") }
    val exerciseDurationM = remember { mutableStateOf("0") }
    val exerciseDurationH = remember { mutableStateOf("0") }
    val exerciseWeight = remember { mutableStateOf("") }
    val exerciseDistance = remember { mutableStateOf("") }
    val exerciseDistanceType = remember { mutableStateOf("m") }

    val distanceShown = remember { mutableStateOf(false) }
    val weightShown = remember { mutableStateOf(false) }
    val timeShown = remember { mutableStateOf(false) }
                    ...
                    Row(
                        ...
                        ExposedDropdownMenuBox(
                            ...
                            TextField(
                                ...
                                onValueChange = {},
                                readOnly = true,
                                trailingIcon = { ExposedDropdownMenuDefaults.TrailingIcon(expanded = dropDownOpen.value)},
                                modifier = Modifier
                                    .menuAnchor()
                            )
                            ExposedDropdownMenu(
                                ...
                                val textKilometres = stringResource(id = R.string.distance_kilometres)
                                DropdownMenuItem(
