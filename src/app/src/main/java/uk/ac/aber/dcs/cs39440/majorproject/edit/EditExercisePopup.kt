...
fun EditExercisePopup(
    ...
    exerciseList: MutableMap<String, Exercise>
) {
    ...
    if (exercise != null) {
        ...
        val exerciseDurationS = remember { mutableStateOf((exercise.exerciseDuration % 3600).toString()) }
        val exerciseDurationM = remember { mutableStateOf((exercise.exerciseDuration / 60 - (exercise.exerciseDuration / 3600) * 60).toString()) }
        val exerciseDurationH = remember { mutableStateOf((exercise.exerciseDuration / 3600).toString()) }
                    ...
                    Row(
                        ...
                        Button(
                            ...
                            onClick = {
                                ...
                                exerciseList[exerciseIndex]?.exerciseName = exerciseName.value
                                exerciseList[exerciseIndex]?.exerciseType = exerciseType.value
                                exerciseList[exerciseIndex]?.exerciseDuration = duration
                                exerciseList[exerciseIndex]?.exerciseDistance = if (exerciseDistance.value != "") if (exerciseDistanceType.value == "m") exerciseDistance.value.toInt() * 1000 else exerciseDistance.value.toInt() else 0
                                exerciseList[exerciseIndex]?.exerciseWeight = if (exerciseWeight.value != "") exerciseWeight.value.toInt() else 0
                                visible.value = false
                            }
                        ) {
